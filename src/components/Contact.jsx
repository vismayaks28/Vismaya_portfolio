...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      'service_ita5kx5', // Replace with your EmailJS service ID
      'template_grw0dw2', // Replace with your EmailJS template ID
      { from_name: form.name, to_name: "Vismaya", from_email: form.email, to_email: "ksvismaya9@gmail.com", message: form.message },
      'ty-EzVNdhr8VqKTAC' // Replace with your EmailJS public key
    ).then(() => {
      setLoading(false);
